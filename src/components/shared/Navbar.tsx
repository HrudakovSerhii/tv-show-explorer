...
const Navbar: React.FC = () => {
  return (
    <header className="border-border bg-background-input sticky top-0 z-50 w-full border-b">
      <div className="mx-auto flex w-full max-w-[1200px] items-center justify-between px-200 py-150 md:px-500">
        <Link href={NAV_URLS.home} className="text-text flex cursor-pointer gap-200">
